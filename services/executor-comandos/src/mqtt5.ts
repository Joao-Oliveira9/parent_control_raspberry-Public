...
// import { handleCreateLog } from './handleLog'; // ✅ novo import
...
//                     case 'create_log':
//                         const domain = message.body['domain'] as string;
//                         const client_ip = message.body['client_ip'] as string;
//                         const client_name = message.body['client_name'] as string;

//                         console.log(`Registrando log de acesso: ${client_name} (${client_ip}) - ${domain}`);
//                         response = await handleCreateLog(domain, client_ip, client_name, message.correlationId);
//                         break;
...
//         console.log('\n🔍 VERIFICAÇÕES MANUAIS:');
//         console.log('1. Certificado ativo no AWS IoT Console?');
//         console.log('2. Política IAM anexada ao certificado?');
//         console.log('3. Política permite iot:Connect?');
//         console.log('4. Endpoint correto para a região us-east-2?');
//         console.log('5. Certificados não expirados?');
//     }
// }
